...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define("CONFIG_LOGIN_USERNAME", 'top');
	define('CONFIG_LOGIN_PASSWORD', 'top');
	...
	define('CONFIG_UPLOAD_MAXSIZE', 10485760 * 10485760 ); //by bytes
	//define('CONFIG_UPLOAD_MAXSIZE', 2048); //by bytes
	//define('CONFIG_UPLOAD_VALID_EXTS', 'txt');//

	define('CONFIG_EDITABLE_VALID_EXTS', 'txt,htm,html,xml,js,css,swf,xml,pdf,zip'); //make you include all these extension in CONFIG_UPLOAD_VALID_EXTS if you want all valid
	
	define('CONFIG_OVERWRITTEN', false); //overwirte when processing paste
	define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,txt,swf,xml,pdf,zip'); // 
	...
	define("CONFIG_VIEWABLE_VALID_EXTS", 'gif,bmp,txt,jpg,png,tif,html,htm,js,css,xml,xsl,dtd,mp3,wav,wmv,wma,rm,rmvb,mov,swf,xml,pdf,zip');
	...
	define('CONFIG_THICKBOX_MAX_HEIGHT', 430);
		 ...
		 * 		
		 */
		 // assets/editor/jscripts/tiny_mce/plugins/ajaxfilemanager
		
	include('../../../../../includes/config.php');
	define('CONFIG_WEBSITE_DOCUMENT_ROOT', EDITORSETTINGS);
